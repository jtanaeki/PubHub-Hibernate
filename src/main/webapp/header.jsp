...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="Home">PubHub</a>
                <br><br><br>
				<div>
					<span style="color: white">
						<small id="user">Hello, <c:out value="${userWelcome}" /></small>
						<c:set var="userWelcome" value="${userWelcome}" scope="request" />
					</span>
				</div>	
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">                	
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li class="divider"></li>
					      <li><a  id="cart" href="ShoppingCart" >Cart - <b><c:out value="${cartCount}" /> Item(s)</b></a></li>
                    ...
                    <li style="margin-left: 80px">
                        <a href="Login"><small id="login">Sign Out</small></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->			
    ...
    <script>
		...
		if(userWelcome.innerHTML == "Hello, "){
