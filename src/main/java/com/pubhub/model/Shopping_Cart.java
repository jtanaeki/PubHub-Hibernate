...
@Entity
@Table(name="shopping_cart", uniqueConstraints=@UniqueConstraint(columnNames={"cart_id"}))
public class Shopping_Cart {
	...
	public Shopping_Cart(String isbn, String title, String author, double price, byte[] content) {
		this.isbn13 = isbn;
		this.title = title;
		this.author = author;
		this.price = price;
	...
	// Constructor used when a date are specified
	public Shopping_Cart(String isbn, String title, String author, double price, byte[] content, LocalDate publishDate) {
		this.isbn13 = isbn;
		this.title = title;
		this.author = author;
		this.price = price;
	...
	public String toString() {
		return "\nShopping_Cart [id=" + id + ", isbn13=" + isbn13 + ", title=" + title + 
